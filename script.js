...
const DOMAIN_DB = {
  ...
  'state.gov':           { rep:'trusted', cat:'US State Department', bias:'Center' },
  'whitehouse.gov':      { rep:'trusted', cat:'US Government', bias:'Center' },
  'congress.gov':        { rep:'trusted', cat:'US Congress', bias:'Center' },
  // ── FACT-CHECKERS ──
  ...
  'boomlive.in':         { rep:'trusted', cat:'Fact-Checker (India)', bias:'Center' },
  'altnews.in':          { rep:'trusted', cat:'Fact-Checker (India)', bias:'Center' },
  'factly.in':           { rep:'trusted', cat:'Fact-Checker (India)', bias:'Center' },
  'vishvasnews.com':     { rep:'trusted', cat:'Fact-Checker (India)', bias:'Center' },
  'afp.com':             { rep:'trusted', cat:'AFP Fact Check — Wire Service', bias:'Center' },
  'reuters.com/fact-check': { rep:'trusted', cat:'Reuters Fact Check', bias:'Center' },
  // ── US MAJOR OUTLETS ──
  ...
  'ft.com':              { rep:'trusted', cat:'Financial Times', bias:'Center' },
  ...
  'theatlantic.com':     { rep:'trusted', cat:'News Magazine', bias:'Left-Center' },
  'thenation.com':       { rep:'trusted', cat:'Progressive Magazine', bias:'Left' },
  'motherjones.com':     { rep:'trusted', cat:'Investigative Journalism', bias:'Left' },
  'rollingstone.com':    { rep:'trusted', cat:'News/Culture Magazine', bias:'Left' },
  'buzzfeednews.com':    { rep:'trusted', cat:'Digital News', bias:'Left-Center' },
  'huffpost.com':        { rep:'trusted', cat:'Digital News', bias:'Left' },
  'mediamatters.org':    { rep:'trusted', cat:'Media Criticism', bias:'Left' },
  'politico.com':        { rep:'trusted', cat:'Political News', bias:'Center' },
  'thehill.com':         { rep:'trusted', cat:'Political News', bias:'Center' },
  'realclearpolitics.com':{ rep:'trusted', cat:'Political Aggregator', bias:'Center-Right' },
  'nationalreview.com':  { rep:'trusted', cat:'Conservative Magazine', bias:'Right-Center' },
  'reason.com':          { rep:'trusted', cat:'Libertarian Magazine', bias:'Center' },
  'usatoday.com':        { rep:'trusted', cat:'National Newspaper', bias:'Left-Center' },
  // ── UK OUTLETS ──
  'independent.co.uk':   { rep:'trusted', cat:'National Newspaper (UK)', bias:'Left-Center' },
  'telegraph.co.uk':     { rep:'trusted', cat:'National Newspaper (UK)', bias:'Right-Center' },
  'thetimes.co.uk':      { rep:'trusted', cat:'National Newspaper (UK)', bias:'Center-Right' },
  'thesun.co.uk':        { rep:'trusted', cat:'Tabloid (UK)', bias:'Right' },
  'dailymail.co.uk':     { rep:'trusted', cat:'Tabloid (UK)', bias:'Right' },
  'mirror.co.uk':        { rep:'trusted', cat:'Tabloid (UK)', bias:'Left' },
  'express.co.uk':       { rep:'trusted', cat:'Tabloid (UK)', bias:'Right' },
  'metro.co.uk':         { rep:'trusted', cat:'Free Newspaper (UK)', bias:'Center' },
  'eveningstandard.co.uk':{ rep:'trusted', cat:'Newspaper (UK)', bias:'Center' },
  'channel4.com':        { rep:'trusted', cat:'Broadcaster (UK)', bias:'Center-Left' },
  'itv.com':             { rep:'trusted', cat:'Broadcaster (UK)', bias:'Center' },
  'sky.com':             { rep:'trusted', cat:'Broadcaster (UK)', bias:'Center' },
  // ── EUROPEAN OUTLETS ──
  'liberation.fr':       { rep:'trusted', cat:'French Newspaper', bias:'Left' },
  'lefigaro.fr':         { rep:'trusted', cat:'French Newspaper', bias:'Right' },
  'lesechos.fr':         { rep:'trusted', cat:'French Financial Paper', bias:'Center-Right' },
  'faz.net':             { rep:'trusted', cat:'German Newspaper', bias:'Center-Right' },
  'sueddeutsche.de':     { rep:'trusted', cat:'German Newspaper', bias:'Center-Left' },
  'zeit.de':             { rep:'trusted', cat:'German Weekly', bias:'Center-Left' },
  'focus.de':            { rep:'trusted', cat:'German Magazine', bias:'Center-Right' },
  'handelsblatt.com':    { rep:'trusted', cat:'German Financial Paper', bias:'Center' },
  'elpais.com':          { rep:'trusted', cat:'Spanish Newspaper', bias:'Center-Left' },
  'elmundo.es':          { rep:'trusted', cat:'Spanish Newspaper', bias:'Center-Right' },
  'lavanguardia.com':    { rep:'trusted', cat:'Spanish Newspaper', bias:'Center' },
  'abc.es':              { rep:'trusted', cat:'Spanish Newspaper', bias:'Right' },
  'corriere.it':         { rep:'trusted', cat:'Italian Newspaper', bias:'Center' },
  'repubblica.it':       { rep:'trusted', cat:'Italian Newspaper', bias:'Center-Left' },
  'lastampa.it':         { rep:'trusted', cat:'Italian Newspaper', bias:'Center-Left' },
  'ilsole24ore.com':     { rep:'trusted', cat:'Italian Financial Paper', bias:'Center' },
  'nrc.nl':              { rep:'trusted', cat:'Dutch Newspaper', bias:'Center-Left' },
  'volkskrant.nl':       { rep:'trusted', cat:'Dutch Newspaper', bias:'Center-Left' },
  'telegraaf.nl':        { rep:'trusted', cat:'Dutch Newspaper', bias:'Right' },
  'nos.nl':              { rep:'trusted', cat:'Dutch Public Broadcaster', bias:'Center' },
  'yle.fi':              { rep:'trusted', cat:'Finnish Public Broadcaster', bias:'Center' },
  'svt.se':              { rep:'trusted', cat:'Swedish Public Broadcaster', bias:'Center' },
  'dn.se':               { rep:'trusted', cat:'Swedish Newspaper', bias:'Center-Left' },
  'aftonbladet.se':      { rep:'trusted', cat:'Swedish Tabloid', bias:'Left' },
  'nrk.no':              { rep:'trusted', cat:'Norwegian Public Broadcaster', bias:'Center' },
  'vg.no':               { rep:'trusted', cat:'Norwegian Tabloid', bias:'Center' },
  'dr.dk':               { rep:'trusted', cat:'Danish Public Broadcaster', bias:'Center' },
  'politiken.dk':        { rep:'trusted', cat:'Danish Newspaper', bias:'Center-Left' },
  'rte.ie':              { rep:'trusted', cat:'Irish Public Broadcaster', bias:'Center' },
  'irishtimes.com':      { rep:'trusted', cat:'Irish Newspaper', bias:'Center-Left' },
  'irishexaminer.com':   { rep:'trusted', cat:'Irish Newspaper', bias:'Center' },
  'independent.ie':      { rep:'trusted', cat:'Irish Newspaper', bias:'Center' },
  'thejournal.ie':       { rep:'trusted', cat:'Irish Digital News', bias:'Center' },
  '24.hu':               { rep:'trusted', cat:'Hungarian News', bias:'Center' },
  'hvg.hu':              { rep:'trusted', cat:'Hungarian Weekly', bias:'Center-Left' },
  'wyborcza.pl':         { rep:'trusted', cat:'Polish Newspaper', bias:'Center-Left' },
  'tvn24.pl':            { rep:'trusted', cat:'Polish Broadcaster', bias:'Center' },
  'novinky.cz':          { rep:'trusted', cat:'Czech News', bias:'Center' },
  'ihned.cz':            { rep:'trusted', cat:'Czech Financial News', bias:'Center' },
  // ── CANADA ──
  'cbc.ca':              { rep:'trusted', cat:'Canadian Public Broadcaster', bias:'Center-Left' },
  'globeandmail.com':    { rep:'trusted', cat:'Canadian Newspaper', bias:'Center' },
  'nationalpost.com':    { rep:'trusted', cat:'Canadian Newspaper', bias:'Center-Right' },
  'torontostar.com':     { rep:'trusted', cat:'Canadian Newspaper', bias:'Left-Center' },
  'theglobeandmail.com': { rep:'trusted', cat:'Canadian Newspaper', bias:'Center' },
  'lapresse.ca':         { rep:'trusted', cat:'Canadian French Newspaper', bias:'Center-Left' },
  // ── AUSTRALIA / NZ ──
  'abc.net.au':          { rep:'trusted', cat:'Australian Public Broadcaster', bias:'Center-Left' },
  'smh.com.au':          { rep:'trusted', cat:'Australian Newspaper', bias:'Center-Left' },
  'theage.com.au':       { rep:'trusted', cat:'Australian Newspaper', bias:'Center-Left' },
  'theaustralian.com.au':{ rep:'trusted', cat:'Australian Newspaper', bias:'Right-Center' },
  'afr.com':             { rep:'trusted', cat:'Australian Financial Review', bias:'Center-Right' },
  'news.com.au':         { rep:'trusted', cat:'Australian News', bias:'Center' },
  'nzherald.co.nz':      { rep:'trusted', cat:'New Zealand Newspaper', bias:'Center' },
  'rnz.co.nz':           { rep:'trusted', cat:'NZ Public Broadcaster', bias:'Center' },
  'stuff.co.nz':         { rep:'trusted', cat:'New Zealand News', bias:'Center' },
  // ── MIDDLE EAST / AFRICA ──
  'haaretz.com':         { rep:'trusted', cat:'Israeli Newspaper', bias:'Left-Center' },
  'jpost.com':           { rep:'trusted', cat:'Jerusalem Post', bias:'Center-Right' },
  'timesofisrael.com':   { rep:'trusted', cat:'Israeli News', bias:'Center' },
  'arabnews.com':        { rep:'trusted', cat:'Saudi English Daily', bias:'Center' },
  'gulfnews.com':        { rep:'trusted', cat:'UAE Newspaper', bias:'Center' },
  'khaleejtimes.com':    { rep:'trusted', cat:'UAE Newspaper', bias:'Center' },
  'egyptindependent.com':{ rep:'trusted', cat:'Egyptian English News', bias:'Center' },
  'dailysabah.com':      { rep:'trusted', cat:'Turkish English News', bias:'Center-Right' },
  'hurriyetdailynews.com':{ rep:'trusted', cat:'Turkish News', bias:'Center' },
  'trtworld.com':        { rep:'trusted', cat:'Turkish Public Broadcaster', bias:'Center' },
  'premiumtimesng.com':  { rep:'trusted', cat:'Nigerian Investigative', bias:'Center' },
  'punch.ng':            { rep:'trusted', cat:'Nigerian Newspaper', bias:'Center' },
  'thisdaylive.com':     { rep:'trusted', cat:'Nigerian Newspaper', bias:'Center' },
  'dailynation.co.ke':   { rep:'trusted', cat:'Kenyan Newspaper', bias:'Center' },
  'nation.africa':       { rep:'trusted', cat:'Pan-African News', bias:'Center' },
  'mg.co.za':            { rep:'trusted', cat:'South African Weekly', bias:'Center-Left' },
  'dailymaverick.co.za': { rep:'trusted', cat:'South African Investigative', bias:'Center-Left' },
  'news24.com':          { rep:'trusted', cat:'South African News', bias:'Center' },
  'timeslive.co.za':     { rep:'trusted', cat:'South African Newspaper', bias:'Center' },
  // ── ASIA-PACIFIC ──
  'straitstimes.com':    { rep:'trusted', cat:'Singapore Newspaper', bias:'Center' },
  'channelnewsasia.com': { rep:'trusted', cat:'Singapore Broadcaster', bias:'Center' },
  ...
  'asahi.com':           { rep:'trusted', cat:'Japanese Newspaper', bias:'Center-Left' },
  'yomiuri.co.jp':       { rep:'trusted', cat:'Japanese Newspaper', bias:'Center-Right' },
  'mainichi.jp':         { rep:'trusted', cat:'Japanese Newspaper', bias:'Center-Left' },
  'nhk.or.jp':           { rep:'trusted', cat:'Japan Public Broadcaster', bias:'Center' },
  'koreaherald.com':     { rep:'trusted', cat:'South Korea English News', bias:'Center' },
  'koreatimes.co.kr':    { rep:'trusted', cat:'South Korea English News', bias:'Center' },
  'bangkokpost.com':     { rep:'trusted', cat:'Thailand Newspaper', bias:'Center' },
  'thenation.com.pk':    { rep:'trusted', cat:'Pakistan English News', bias:'Center' },
  'dawn.com':            { rep:'trusted', cat:'Pakistan Newspaper', bias:'Center' },
  'geo.tv':              { rep:'trusted', cat:'Pakistan Broadcaster', bias:'Center' },
  'thedailystar.net':    { rep:'trusted', cat:'Bangladesh Newspaper', bias:'Center' },
  'prothomalo.com':      { rep:'trusted', cat:'Bangladesh Newspaper', bias:'Center' },
  'myanmartimes.com.mm': { rep:'trusted', cat:'Myanmar Newspaper', bias:'Center' },
  'phnompenhpost.com':   { rep:'trusted', cat:'Cambodia Newspaper', bias:'Center' },
  'voanews.com':         { rep:'trusted', cat:'Voice of America', bias:'Center' },
  'rferl.org':           { rep:'trusted', cat:'Radio Free Europe', bias:'Center' },
  'bbc.com':             { rep:'trusted', cat:'UK Public Broadcaster', bias:'Center-Left' },
  'bbc.co.uk':           { rep:'trusted', cat:'UK Public Broadcaster', bias:'Center-Left' },
  // ── LATIN AMERICA ──
  'folha.uol.com.br':    { rep:'trusted', cat:'Brazilian Newspaper', bias:'Center-Left' },
  'estadao.com.br':      { rep:'trusted', cat:'Brazilian Newspaper', bias:'Center-Right' },
  'globo.com':           { rep:'trusted', cat:'Brazilian Broadcaster', bias:'Center' },
  'g1.globo.com':        { rep:'trusted', cat:'Brazilian News Portal', bias:'Center' },
  'clarin.com':          { rep:'trusted', cat:'Argentine Newspaper', bias:'Center' },
  'lanacion.com.ar':     { rep:'trusted', cat:'Argentine Newspaper', bias:'Center-Right' },
  'infobae.com':         { rep:'trusted', cat:'Argentine News Portal', bias:'Center' },
  'eluniversal.com.mx':  { rep:'trusted', cat:'Mexican Newspaper', bias:'Center' },
  'reforma.com':         { rep:'trusted', cat:'Mexican Newspaper', bias:'Center' },
  'proceso.com.mx':      { rep:'trusted', cat:'Mexican Weekly', bias:'Center-Left' },
  'latimes.com':         { rep:'trusted', cat:'US Regional Newspaper', bias:'Left-Center' },
  // ── SCIENCE / ACADEMIC ──
  'nature.com':          { rep:'trusted', cat:'Scientific Journal', bias:'Center' },
  'science.org':         { rep:'trusted', cat:'Scientific Journal', bias:'Center' },
  'thelancet.com':       { rep:'trusted', cat:'Medical Journal', bias:'Center' },
  'nejm.org':            { rep:'trusted', cat:'Medical Journal', bias:'Center' },
  'bmj.com':             { rep:'trusted', cat:'Medical Journal (UK)', bias:'Center' },
  'cell.com':            { rep:'trusted', cat:'Scientific Journal', bias:'Center' },
  'newscientist.com':    { rep:'trusted', cat:'Science Magazine', bias:'Center-Left' },
  'phys.org':            { rep:'trusted', cat:'Science News', bias:'Center' },
  'livescience.com':     { rep:'trusted', cat:'Science News', bias:'Center' },
  'space.com':           { rep:'trusted', cat:'Space/Science News', bias:'Center' },
  // ── WIRE SERVICES ──
  'apnews.com':          { rep:'trusted', cat:'Associated Press — Wire Service', bias:'Center' },
  'reuters.com':         { rep:'trusted', cat:'Reuters — Wire Service', bias:'Center' },
  'afp.com':             { rep:'trusted', cat:'Agence France-Presse', bias:'Center' },
  'ians.in':             { rep:'trusted', cat:'Indo-Asian News Service', bias:'Center' },
  'xinhuanet.com':       { rep:'trusted', cat:'Chinese State Wire', bias:'Center' },
  'kyodonews.net':       { rep:'trusted', cat:'Japanese Wire Service', bias:'Center' },
  'yonhapnews.co.kr':    { rep:'trusted', cat:'Korean Wire Service', bias:'Center' },
  'tass.com':            { rep:'trusted', cat:'Russian State Wire', bias:'Center' },
  ...
  'timesofindia.indiatimes.com':{ rep:'trusted', cat:'Indian National Newspaper', bias:'Center' },
  ...
  'economictimes.indiatimes.com':{ rep:'trusted', cat:'Indian Financial News', bias:'Center' },
  ...
  'aninews.in':          { rep:'trusted', cat:'Indian News Agency — ANI', bias:'Center' },
  'pti.in':              { rep:'trusted', cat:'Indian News Agency — PTI', bias:'Center' },
  'hindustantimes.com':  { rep:'trusted', cat:'Indian National Newspaper', bias:'Center' },
  'zeebiz.com':          { rep:'trusted', cat:'Indian Business News', bias:'Center' },
  'moneycontrol.com':    { rep:'trusted', cat:'Indian Business News', bias:'Center' },
  'cnbctv18.com':        { rep:'trusted', cat:'Indian Business News', bias:'Center' },
  'tv9bharatvarsh.com':  { rep:'trusted', cat:'Indian Broadcast News', bias:'Center' },
  'abplive.com':         { rep:'trusted', cat:'Indian Broadcast News', bias:'Center' },
  'aajtak.in':           { rep:'trusted', cat:'Indian Broadcast News', bias:'Center' },
  'indiatvnews.com':     { rep:'trusted', cat:'Indian Broadcast News', bias:'Center' },
  'freepressjournal.in': { rep:'trusted', cat:'Indian Newspaper', bias:'Center' },
  'thestatesman.com':    { rep:'trusted', cat:'Indian Newspaper', bias:'Center' },
  'newindianexpress.com':{ rep:'trusted', cat:'Indian Newspaper', bias:'Center' },
  'mathrubhumi.com':     { rep:'trusted', cat:'Indian Regional Newspaper', bias:'Center' },
  'manoramaonline.com':  { rep:'trusted', cat:'Indian Regional Newspaper', bias:'Center' },
  'thehansindia.com':    { rep:'trusted', cat:'Indian Newspaper', bias:'Center' },
  'daijiworld.com':      { rep:'trusted', cat:'Indian Regional News', bias:'Center' },
  'oneindia.com':        { rep:'trusted', cat:'Indian Digital News', bias:'Center' },
  'india.com':           { rep:'trusted', cat:'Indian News Portal', bias:'Center' },
  // ── RUSSIA / EASTERN EUROPE ──
  'moscowtimes.com':     { rep:'trusted', cat:'English-language Russia News', bias:'Center' },
  'meduza.io':           { rep:'trusted', cat:'Independent Russian News', bias:'Center-Left' },
  'kyivindependent.com': { rep:'trusted', cat:'Ukrainian Newspaper', bias:'Center' },
  'ukrinform.net':       { rep:'trusted', cat:'Ukrainian News Agency', bias:'Center' },
  // ── TECH/BUSINESS ──
  'techcrunch.com':      { rep:'trusted', cat:'Tech News', bias:'Left-Center' },
  'theverge.com':        { rep:'trusted', cat:'Tech News', bias:'Left-Center' },
  'engadget.com':        { rep:'trusted', cat:'Tech News', bias:'Left-Center' },
  'cnet.com':            { rep:'trusted', cat:'Tech News', bias:'Center' },
  'zdnet.com':           { rep:'trusted', cat:'Tech News', bias:'Center' },
  'venturebeat.com':     { rep:'trusted', cat:'Tech News', bias:'Center' },
  'businessinsider.com': { rep:'trusted', cat:'Business News', bias:'Center-Left' },
  'forbes.com':          { rep:'trusted', cat:'Business Magazine', bias:'Center-Right' },
  'fortune.com':         { rep:'trusted', cat:'Business Magazine', bias:'Center' },
  'cnbc.com':            { rep:'trusted', cat:'Financial Broadcaster', bias:'Center' },
  'marketwatch.com':     { rep:'trusted', cat:'Financial News', bias:'Center' },
